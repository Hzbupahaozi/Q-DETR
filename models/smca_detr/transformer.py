...
class Transformer(nn.Module):
    ...
    def forward(self, src, mask, query_embed, pos_embed, h_w, reshape_output_t1, reshape_output_t2):
        ...
        hs, points, D = self.decoder(grid, h_w, tgt, memory, reshape_output_t1, reshape_output_t2, memory_key_padding_mask=mask,
...
class TransformerDecoder(nn.Module):
    ...
    def forward(self, grid, h_w, tgt, memory,
                reshape_output_t1, reshape_output_t2,
...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward_post(self, grid, h_w, tgt, memory,
        ...
        mask1 = torch.any(reshape_output_t1 == 0, dim=1)
        object_query1[mask1] = 0
        mask2 = torch.any(reshape_output_t2 == 0, dim=1)
