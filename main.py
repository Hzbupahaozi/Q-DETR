...
def get_args_parser():
    ...
    parser.add_argument('--finetune', default='', help='resume from checkpoint')
...
def main(args):
    ...
    if args.finetune:
        model_without_ddp.load_state_dict(torch.load(args.finetune, map_location='cpu')['model'], strict=False)
